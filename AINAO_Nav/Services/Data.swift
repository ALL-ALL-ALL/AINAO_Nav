...
extension AllModel {
 ...
 longtitude: pot.longitude,
    ...
    func getPOIs() async  -> [POI] {
        ...
        let result: [POI] = [] // This will hold the result of the asynchronous operation
    ...
    func getUserProfile(userRef: String) async -> (Bool, UserProfileRestore?) {
        ...
        var isSuccess = true
        let profile = UserProfileRestore(id : UUID(),username : "Clint Eastwood", mail : "clint@hollywood.com" )
    ...
    func getUserProfile(userRef: String) -> (Bool, UserProfileRestore?) {
        ...
        // Example of filling the data
        profile.profilePicture = Image("adele")
