...
//    let apiUrl = "https://api.openweathermap.org/data/2.5/weather?q=Paris&appid=3dfe813699403684b4ca7e507c7aa26c&units=metric"
    ...
    let apiUrl = "https://api.openweathermap.org/data/2.5/weather?q=Toulouse&appid=3dfe813699403684b4ca7e507c7aa26c&units=metric&lang=fr"
...
//    let apiUrl = apiUrl1 + apiUrl2 + apiUrl3
    ...
    func fetchWeatherMeteo() async {
        ...
        do{
            ...
            let _ = print(data) // pour debug

            //convertir les données
            let decodedData = try  JSONDecoder().decode(WeatherResponse.self, from: data)
            let _ = print("4444444") // pour debug
